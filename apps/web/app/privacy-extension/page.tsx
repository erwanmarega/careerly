...
export default function PrivacyExtensionPage() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-16 text-foreground leading-relaxed">
      ...
      <p className="text-muted-foreground text-sm mb-2">L&apos;extension Careerly collecte uniquement les données nécessaires à son fonctionnement :</p>
      ...
      <p className="text-muted-foreground text-sm">Les données extraites de la page sont utilisées exclusivement pour pré-remplir le formulaire d&apos;ajout de candidature dans Careerly. Elles sont transmises à l&apos;API Careerly uniquement lorsque vous soumettez le formulaire.</p>
      ...
      <p className="text-muted-foreground text-sm mb-2">Careerly ne collecte pas :</p>
      <ul className="text-muted-foreground text-sm list-disc pl-5 space-y-1">
