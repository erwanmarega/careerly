    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_440px] gap-12 items-end">
            <div className="pb-20">
              ...
              <p className="text-base text-zinc-400 leading-relaxed mb-3 max-w-sm">
                Postulo connecte vos étudiants à votre tableau de bord. Vous voyez leurs candidatures au fil de l'eau, sans leur envoyer un seul message.
              </p>
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-10 py-20">
        <p className="text-sm text-muted-foreground max-w-xl leading-relaxed mb-12">
          En fin d'année, la plupart des responsables de formation découvrent trop tard que des étudiants n'ont toujours rien. Postulo leur donne cette visibilité en continu, sans chasser les étudiants par email.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px border border-border rounded-2xl overflow-hidden bg-border">
          {[
            { label: 'Qui n\'a pas encore postulé', desc: 'Identifiez les étudiants inactifs avant qu\'il soit trop tard.' },
            { label: 'Où en est chaque étudiant', desc: 'Candidatures envoyées, entretiens en cours, offres reçues — tout d\'un coup d\'œil.' },
            { label: 'Le taux de placement de votre promo', desc: 'Un chiffre concret pour vos bilans, mis à jour en temps réel.' },
          ].map((item) => (
      ...
      <section className="border-t border-border">
        <div className="max-w-6xl mx-auto px-6 sm:px-10 py-20">
          <p className="text-xs text-muted-foreground uppercase tracking-widest mb-10">Comment ça marche</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div className="space-y-8">
              <div>
                <p className="text-sm font-semibold text-primary mb-1">Pour l'école</p>
                <p className="text-2xl font-bold tracking-tight mb-3">Vous créez votre espace, on vous donne un code.</p>
                <p className="text-sm text-muted-foreground leading-relaxed">Partagez ce code à vos étudiants. Ceux qui s'inscrivent sur Postulo rejoignent automatiquement votre tableau de bord.</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-zinc-500 mb-1">Pour les étudiants</p>
                <p className="text-2xl font-bold tracking-tight mb-3">Ils suivent leurs candidatures. Vous les voyez.</p>
                <p className="text-sm text-muted-foreground leading-relaxed">Chaque candidature ajoutée par un étudiant apparaît dans votre dashboard. Pas de saisie manuelle, pas de formulaires à remplir.</p>
              </div>
            </div>
      ...
      <section id="tarifs" className="bg-zinc-950 text-white border-t border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 sm:px-10 py-20">
          <p className="text-xs text-zinc-500 uppercase tracking-widest mb-10">Tarifs</p>
          <p className="text-zinc-400 text-sm mb-12 max-w-sm">
            Les étudiants utilisent Postulo gratuitement. L'école paie un abonnement annuel par promotion.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
              <p className="text-xs text-zinc-500 uppercase tracking-widest mb-6">Starter</p>
              <p className="text-3xl font-black text-white mb-1">Sur devis</p>
              <p className="text-sm text-zinc-600 mb-8">1 promotion · jusqu'à 50 étudiants</p>
              <a
                href="mailto:contact@postulo.fr"
            ...
            <div className="bg-zinc-900 border-2 border-primary rounded-2xl p-8">
              <p className="text-xs text-primary uppercase tracking-widest mb-6">Pro</p>
              <p className="text-3xl font-black text-white mb-1">Sur devis</p>
              <p className="text-sm text-zinc-600 mb-8">Promotions illimitées</p>
              <a
                href="mailto:contact@postulo.fr"
